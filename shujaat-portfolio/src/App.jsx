...
import { FaLinkedin, FaGithub, FaEnvelope, FaInstagram, FaReact, FaLaravel, FaGitAlt, FaDatabase, FaCode, FaPhone, FaMapMarkerAlt, FaArrowRight, FaDownload, FaPlay, FaEye, FaUsers, FaCoffee, FaAward, FaBars, FaTimes, FaChevronUp, FaDocker, FaServer, FaCloud, FaTerminal, FaUbuntu, FaLinux } from 'react-icons/fa';
import { SiNextdotjs, SiDjango, SiMysql, SiWordpress, SiBootstrap, SiTailwindcss, SiJavascript, SiTypescript, SiNginx, SiGunicorn, SiKubernetes, SiDigitalocean, SiGit, SiPython } from 'react-icons/si';
      ...
      {nebulaClouds.map((nebula) => (
        <motion.div
          ...
          className={`absolute rounded-full filter blur-3xl opacity-20 ${
            nebula.color === 'purple' ? 'bg-purple-500' :
            nebula.color === 'blue' ? 'bg-blue-500' : 'bg-pink-500'
          }`}
          style={{
            width: nebula.size,
            height: nebula.size,
...
const GlassCard = ({ children, className = "", hover = true, glow = false }) => (
  <motion.div
    ...
    whileHover={hover ? { 
      y: -8, 
      scale: 1.02,
      boxShadow: glow ? '0 25px 50px rgba(147, 51, 234, 0.3)' : '0 25px 50px rgba(0, 0, 0, 0.5)'
    } : {}}
...
const App = () => {
  ...
  const personalInfo = {
    ...
    summary: "Passionate Frontend Developer with expertise in creating stunning, responsive web applications using cutting-edge technologies. Experienced in DevOps practices, server management, and cloud infrastructure. I transform complex ideas into elegant, scalable digital experiences."
  };
  ...
  const education = [
    {
      ...
      description: 'Advanced studies in machine learning, big data analytics, statistical modeling, and AI applications.',
      icon: '🎓',
      gpa: 'Current'
    },
    {
      ...
      description: 'Specialized in computational physics, electronics, and mathematical modeling.',
      icon: '🔬',
      gpa: 'Honors'
    }
  ];
  ...
  const skills = [
    // Frontend Skills
    { name: 'React', icon: FaReact, level: 95, color: 'from-blue-400 to-cyan-400', category: 'Frontend' },
    { name: 'Next.js', icon: SiNextdotjs, level: 90, color: 'from-gray-300 to-gray-600', category: 'Frontend' },
    { name: 'TypeScript', icon: SiTypescript, level: 88, color: 'from-blue-600 to-blue-800', category: 'Language' },
    { name: 'JavaScript', icon: SiJavascript, level: 92, color: 'from-yellow-400 to-yellow-600', category: 'Language' },
    { name: 'Tailwind CSS', icon: SiTailwindcss, level: 94, color: 'from-teal-400 to-blue-500', category: 'Styling' },
    
    // Backend Skills
    { name: 'Laravel', icon: FaLaravel, level: 85, color: 'from-red-400 to-orange-400', category: 'Backend' },
    { name: 'Django', icon: SiDjango, level: 80, color: 'from-green-400 to-green-600', category: 'Backend' },
    { name: 'Python', icon: SiPython, level: 85, color: 'from-blue-500 to-yellow-500', category: 'Language' },
    
    // Database
    { name: 'MySQL', icon: SiMysql, level: 87, color: 'from-blue-500 to-blue-700', category: 'Database' },
    
    // DevOps Skills
    { name: 'Ubuntu/Linux', icon: FaUbuntu, level: 88, color: 'from-orange-500 to-red-500', category: 'DevOps' },
    { name: 'Nginx', icon: SiNginx, level: 85, color: 'from-green-500 to-green-700', category: 'DevOps' },
    { name: 'Gunicorn', icon: SiGunicorn, level: 82, color: 'from-green-400 to-lime-500', category: 'DevOps' },
    { name: 'Docker', icon: FaDocker, level: 80, color: 'from-blue-500 to-blue-600', category: 'DevOps' },
    { name: 'Git', icon: FaGitAlt, level: 90, color: 'from-orange-500 to-red-500', category: 'DevOps' },
    // { name: 'AWS', icon: SiAmazonaws, level: 75, color: 'from-yellow-500 to-orange-500', category: 'Cloud' },
    { name: 'DigitalOcean', icon: SiDigitalocean, level: 85, color: 'from-blue-500 to-blue-600', category: 'Cloud' }
  ];

  const projects = [
    {
      title: 'SMM Production Dashboard',
      description: 'A comprehensive social media management platform with real-time analytics, automated posting, and team collaboration features.',
      longDescription: 'Built with React 18, Redux Toolkit, and WebSocket integration for real-time updates. Deployed on Ubuntu server with Nginx.',
      tech: ['React', 'Redux', 'WebSocket', 'Chart.js', 'Tailwind CSS', 'Nginx', 'Ubuntu'],
    ...
    },
    {
      ...
      description: 'Enterprise-grade WordPress plugin with dynamic pricing, multi-vendor support, and payment gateway integration.',
      longDescription: 'Custom post types, AJAX-powered interface, and seamless payment processing. Deployed using Gunicorn and Nginx.',
      tech: ['PHP', 'WordPress', 'AJAX', 'MySQL', 'Docker', 'Gunicorn'],
    ...
    },
    {
      ...
      description: 'Complete DevOps solution with automated deployment, monitoring, and scaling on AWS and DigitalOcean.',
      longDescription: 'Configured Ubuntu servers, Nginx reverse proxy, SSL certificates, and CI/CD pipelines.',
      tech: ['Ubuntu', 'Nginx', 'Docker', 'AWS', 'DigitalOcean', 'Git'],
  ...
  const services = [
    {
      ...
      icon: FaCode,
      features: ['React & Next.js Apps', 'Progressive Web Apps', 'Mobile-First Design', 'Performance Optimization'],
      color: 'from-purple-500 to-pink-500'
    },
    {
      title: 'DevOps & Infrastructure',
      description: 'Server management, deployment automation, and cloud infrastructure setup.',
      icon: FaServer,
      features: ['Linux Server Management', 'Nginx Configuration', 'Docker Deployment', 'CI/CD Pipelines'],
      color: 'from-blue-500 to-cyan-500'
    },
    {
      title: 'Full-Stack Solutions',
      description: 'End-to-end web applications with robust backend and seamless API integrations.',
      icon: FaDatabase,
      features: ['RESTful API Design', 'Database Architecture', 'Server Configuration', 'Cloud Deployment'],
      color: 'from-green-500 to-teal-500'
    }
  ];

  const stats = [
    { icon: FaEye, number: '50+', label: 'Projects Delivered', color: 'from-purple-500 to-purple-600' },
    { icon: FaUsers, number: '30+', label: 'Happy Clients', color: 'from-pink-500 to-pink-600' },
    { icon: FaServer, number: '10+', label: 'Servers Managed', color: 'from-blue-500 to-cyan-500' },
    { icon: FaAward, number: '99%', label: 'Success Rate', color: 'from-purple-500 to-pink-500' }
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden relative">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative pt-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Left Content */}
          <motion.div
            initial={{ opacity: 0, x: -100 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 1.2, delay: 0.2, ease: [0.23, 1, 0.320, 1] }}
          ...
          >
            ...
            >
              <motion.button
                className="group bg-gradient-to-r from-purple-500 to-pink-500 px-8 py-4 rounded-full font-semibold flex items-center justify-center gap-3 text-sm uppercase tracking-wider shadow-xl hover:shadow-purple-500/30 transition-all duration-300"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              ...
              <motion.button
                className="group backdrop-blur-xl bg-white/10 border border-white/20 px-8 py-4 rounded-full font-semibold flex items-center justify-center gap-3 text-sm uppercase tracking-wider hover:bg-white/15 transition-all duration-300"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
            ...
            >
              {[
                { icon: FaGithub, href: personalInfo.github, color: "hover:text-gray-300", label: "GitHub" },
                { icon: FaLinkedin, href: personalInfo.linkedin, color: "hover:text-blue-400", label: "LinkedIn" },
                { icon: FaInstagram, href: personalInfo.instagram, color: "hover:text-pink-400", label: "Instagram" },
                { icon: FaEnvelope, href: `mailto:${personalInfo.email}`, color: "hover:text-red-400", label: "Email" }
              ].map((social, index) => (
                <motion.a
                  key={index}
                  href={social.href}
            ...
            <div className="relative w-full h-96 sm:h-[500px] lg:h-[600px]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                >
                  ...
                  {/* Tech icons orbiting */}
                  {[
                    { Icon: FaReact, color: 'text-blue-400', radius: 120, speed: 20 },
                    { Icon: SiNginx, color: 'text-green-400', radius: 140, speed: 25 },
                    { Icon: FaDocker, color: 'text-blue-500', radius: 160, speed: 30 },
                    { Icon: FaUbuntu, color: 'text-orange-500', radius: 180, speed: 35 },
                    { Icon: SiTypescript, color: 'text-blue-600', radius: 100, speed: 15 },
                    { Icon: FaServer, color: 'text-purple-400', radius: 130, speed: 22 }
                  ].map((item, index) => (
                    <motion.div
                      key={index}
              ...
              >
                <code className="text-purple-400 text-sm font-mono">
                  <span className="text-pink-400">const</span> galaxy = <span className="text-cyan-400">"infinite"</span>;
                </code>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <GlassCard className="p-6 sm:p-8 group-hover:bg-white/10 transition-all duration-500" glow>
                  <motion.div
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <motion.div variants={itemVariants} className="space-y-8">
              ...
              <motion.div variants={itemVariants} className="grid grid-cols-2 gap-6">
                ...
                >
                  <h4 className="font-semibold text-purple-300 uppercase tracking-wider text-sm">Experience</h4>
                  <p className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">1.5+ Years</p>
                </motion.div>
                <motion.div 
                  className="space-y-2 text-center p-6 rounded-2xl bg-white/5 border border-white/10"
                  whileHover={{ scale: 1.05, backgroundColor: 'rgba(255,255,255,0.1)' }}
                >
                  <h4 className="font-semibold text-purple-300 uppercase tracking-wider text-sm">Projects</h4>
                  <p className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">50+</p>
                </motion.div>
              </motion.div>
            ...
            <motion.div variants={itemVariants}>
              <GlassCard className="p-8 sm:p-10" glow>
                ...
                <div className="mt-8 space-y-4">
                  <h5 className="font-semibold text-purple-300 uppercase tracking-wider text-sm">Key Achievements:</h5>
                  <div className="space-y-3">
                    {experience.responsibilities.slice(0, 3).map((resp, index) => (
                      ...
                      >
                        ...
                        <span className="text-sm text-white/70 leading-relaxed">{resp}</span>
                      </motion.div>
                    ))}
                  </div>
                </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={itemVariants} className="text-center mb-16">
            <span className="inline-block text-purple-400 font-semibold text-lg uppercase tracking-wider mb-4">Services</span>
            ...
            <p className="text-white/70 text-lg max-w-3xl mx-auto leading-relaxed">
              Comprehensive web development and DevOps solutions tailored to your business needs
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                className="group"
              >
                <GlassCard className="p-8 h-full group-hover:bg-white/10 transition-all duration-500" glow>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={itemVariants} className="text-center mb-16">
            <span className="inline-block text-purple-400 font-semibold text-lg uppercase tracking-wider mb-4">Skills</span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
              Technical <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Expertise</span>
            </h2>
            <p className="text-white/70 text-lg max-w-3xl mx-auto leading-relaxed">
              Modern technologies, frameworks, and DevOps tools I use to create exceptional digital experiences
            </p>
          </motion.div>
          
          {/* Skill Categories */}
          <div className="mb-12 flex flex-wrap justify-center gap-4">
            {['All', 'Frontend', 'Backend', 'DevOps', 'Language', 'Database', 'Cloud'].map((category) => (
              <motion.button
                key={category}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {skills.map((skill, index) => (
              <motion.div
                ...
                className="group"
              >
                <GlassCard className="p-6 text-center group-hover:bg-white/10 transition-all duration-500 h-full" glow>
                  <motion.div
                    className="mb-6"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-xs text-white/60 uppercase tracking-wider">{skill.category}</span>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={itemVariants} className="text-center mb-16">
            <span className="inline-block text-purple-400 font-semibold text-lg uppercase tracking-wider mb-4">Portfolio</span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
              Featured <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Projects</span>
            </h2>
            <p className="text-white/70 text-lg max-w-3xl mx-auto leading-relaxed">
              Showcase of my recent work in web development and DevOps, featuring cutting-edge technologies and innovative solutions
            </p>
          </motion.div>
                      ...
                      <div className="grid grid-cols-3 gap-4 p-4 bg-white/5 rounded-xl border border-white/10">
                        {Object.entries(project.metrics).map(([key, value]) => (
                          <div key={key} className="text-center">
                            <div className="text-xs text-white/60 uppercase tracking-wider mb-1">{key}</div>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={itemVariants} className="text-center mb-16">
            <span className="inline-block text-purple-400 font-semibold text-lg uppercase tracking-wider mb-4">Education</span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
              Academic <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Journey</span>
            </h2>
            <p className="text-white/70 text-lg max-w-3xl mx-auto leading-relaxed">
              My educational foundation and continuous learning path in technology and science
            </p>
          </motion.div>
          ...
          <div className="space-y-8">
            {education.map((edu, index) => (
              <motion.div
                ...
                className="group"
              >
                <GlassCard className="p-8 group-hover:bg-white/5 transition-all duration-500" glow>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={itemVariants} className="text-center mb-16">
            <span className="inline-block text-purple-400 font-semibold text-lg uppercase tracking-wider mb-4">Contact</span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <motion.div variants={itemVariants}>
              <GlassCard className="p-8" glow>
                <h3 className="text-2xl font-semibold mb-8 text-center">Send Message</h3>
                
                <div className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <div className="block text-sm font-medium text-white/80 mb-2 uppercase tracking-wider">Name</div>
                    ...
                    <div>
                      <div className="block text-sm font-medium text-white/80 mb-2 uppercase tracking-wider">Email</div>
                      <div className="w-full px-4 py-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl text-white/60 hover:border-purple-400/50 transition-colors">
                        your@email.com
                      </div>
                    </div>
                  ...
                  <div>
                    <div className="block text-sm font-medium text-white/80 mb-2 uppercase tracking-wider">Subject</div>
                    <div className="w-full px-4 py-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl text-white/60 hover:border-purple-400/50 transition-colors">
                      Project inquiry
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="block text-sm font-medium text-white/80 mb-2 uppercase tracking-wider">Message</div>
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.02, y: -2 }}
                    whileTap={{ scale: 0.98 }}
                    onClick={() => window.open(`mailto:${personalInfo.email}?subject=Project Inquiry&body=Hello Shujaat, I would like to discuss a project with you.`)}
                  >
                    Send Message 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-3 gap-8 items-center">
              ...
              >
                ...
                <p className="text-white/60 text-sm">Creating Digital Excellence</p>
              </motion.div>
              ...
              <GlassCard className="h-full p-8 flex flex-col" glow>
                ...
                <div className="border-t border-white/20 pt-6 mt-6">
                  <div className="text-center space-y-4">
                    <p className="text-white/60 text-sm">Ready to work together?</p>
                    <motion.a
                      href="tel:+923112957276"
